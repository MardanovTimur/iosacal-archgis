# -*- coding: utf-8 -*-
#
# GNUCal documentation build configuration file, created by
...
project = u'IOSACal'
copyright = u'2018 Stefano Costa and the IOSA project'
...
latex_documents = [
  ('index', 'IOSACal.tex', u'IOSACal Documentation',
   u'Stefano Costa', 'manual'),
]
